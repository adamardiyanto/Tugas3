...
public class OlshopAdapter extends RecyclerView.Adapter<OlshopAdapter.ViewHolder> {
    private Context context;
    private ArrayList<OlshopModel> olshopModels;

    public OlshopAdapter(Context context) {
        this.context = context;
    }

    public ArrayList<OlshopModel> getOlshopModels() {
        return olshopModels;
    }
    public void setOlshopModels(ArrayList<OlshopModel> olshopModels) {
        this.olshopModels = olshopModels;
    }

    @NonNull
    @Override
    public OlshopAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull OlshopAdapter.ViewHolder viewHolder, int i) {
